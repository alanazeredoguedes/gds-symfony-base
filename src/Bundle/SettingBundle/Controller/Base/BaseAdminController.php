...
class BaseAdminController extends CRUDController
{
    ...
    public function listAction(Request $request): Response
    {
        ...
        $template = $this->baseTemplate . 'list.html.twig';
    ...
    public function showAction(Request $request): Response
    {
        ...
        $template = $this->baseTemplate . "show.html.twig";
    ...
    public function createAction(Request $request): Response
    {
        ...
        $template = $this->baseTemplate . "create.html.twig";
        /**
         * @psalm-suppress DeprecatedMethod
         */
        return $this->renderWithExtraParams($template, [
    ...
    public function editAction(Request $request): Response
    {
        ...
        $template = $this->baseTemplate . "edit.html.twig";
